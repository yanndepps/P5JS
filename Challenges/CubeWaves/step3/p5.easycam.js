...
(function(ext) {
  ...
  var EasyCam = class {
    ...
    constructor(renderer, args) {
      ...
      this.dampedZoom = new DampedAction(this, function(d) {
        cam.zoom(d * cam.getZoomMult());
      });
      this.dampedPanX = new DampedAction(this, function(d) {
        cam.panX(d * cam.getPanMult());
      });
      this.dampedPanY = new DampedAction(this, function(d) {
        cam.panY(d * cam.getPanMult());
      });
      this.dampedRotX = new DampedAction(this, function(d) {
        cam.rotateX(d * cam.getRotationMult());
      });
      this.dampedRotY = new DampedAction(this, function(d) {
        cam.rotateY(d * cam.getRotationMult());
      });
      this.dampedRotZ = new DampedAction(this, function(d) {
